...
/* whether 2nd arg to iconv() is const ptr */
/* #undef ICONV_INBUF_CONST */
...
/* Full name OS */
#define OS_UNAME "Linux coreseek-69107 3.10.0-957.el7.x86_64 #1 SMP Thu Nov 8 23:39:32 UTC 2018 x86_64 x86_64 x86_64 GNU/Linux"
...
/* 64-bit document and word IDs */
#define USE_64BIT 0

/* define to use expat XML library */
/* #undef USE_LIBEXPAT */

/* define to use iconv library */
/* #undef USE_LIBICONV */
...
/* Define to 1 if you want to compile with libmmseg support */
#define USE_MMSEG 1

/* Define to 1 if you want to compile with MySQL support */
#define USE_MYSQL 1

/* define to use ODBC library */
/* #undef USE_ODBC */
